...
# Check if "ID" column exists, otherwise create one using index
...
# Choosing winners based on "ID" column, update n based on requiredment
winner = df.sample(n=2)
